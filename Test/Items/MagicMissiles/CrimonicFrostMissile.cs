...
{
	public class CrimonicFrostMissile : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Gain Ichor buff at night.");
		}
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType<CrimonicFrostMissileHead>();
			item.shootSpeed = 10f;
		}
	...
	public class CrimonicFrostMissileHead : ModProjectile
	{
		public override void SetDefaults() {
			projectile.width = 10;

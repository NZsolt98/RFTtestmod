...
{
	public class FrostMissile : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Shoots Frostburn missiles.");
		}
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType<FrostMissileHead>();
			item.shootSpeed = 10f;
		}		
	...
	public class FrostMissileHead : ModProjectile
	{
		public override void SetDefaults() {
			projectile.width = 10;
